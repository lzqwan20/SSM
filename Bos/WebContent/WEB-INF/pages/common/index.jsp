...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEp").click(function(){
			...
			if(v){
				...
				if(v1 == v2){
					//两次输入一致，发送ajax请求
					$.post("editPassword.action",{"password":v1},function(data){
						if(data == '1'){
							//修改成功，关闭修改密码窗口
							$("#editPwdWindow").window("close");
						}else{
	...
	// 版权信息
	function showAbout(){
		$.messager.alert("宅急送 v1.0","管理员邮箱: 2715775424@qq.com");
	}
</script>
</head>
	...
	<div data-options="region:'center'">
		<div id="tabs" fit="true" class="easyui-tabs" border="false">
			<div title="消息中心" id="subWarp"
				...
				<iframe src="${pageContext.request.contextPath }/User/page_common_home.action"
				...
				<tr>
					<td style="width: 300px;">
						<div style="color: #999; font-size: 8pt;">
							广州 中医药大学 | Powered by <a href="http://www.gzucm.edu.cn//">http://www.gzucm.edu.cn/</a>
						</div>
					</td>
