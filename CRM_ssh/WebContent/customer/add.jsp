...
function loadSelect(dict_type_code,positionId){
	$("#"+positionId).append("<option value=''>----请选择------</option>");
	$.post("${pageContext.request.contextPath}/BaseDictAction_findByTypeCode", { dict_type_code:dict_type_code },
	          function(data){
...
$(document).ready(function(){
	loadSelect("001","industry");
	loadSelect("006","level");
	loadSelect("009","source");
});
</script>
...
<BODY>
	...
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/CustomerAction_saveCustomer"
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<select id="level" name="cust_level.dict_id"></select>
								</td>
							</TR>
							...
							<TR>
								<td>信息来源 ：</td>
								<td>
								<select id="source" name="cust_source.dict_id"></select>
								</td>
								<td>客户行业：</td>
								<td>
								<select id="industry" name="cust_industry.dict_id"></select>
								</td>
							</TR>
